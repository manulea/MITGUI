...
class App(QDialog):
                ...
                for (i, rect) in enumerate(rects):
                    ...
                    if(gesture_output == 0):
                        ...
                        for i in range(27, 36, 1):
                            cv2.circle(frame, (shape[i][0], shape[i][1]), 2, (255, 0, 0), -1)
                    # If any gesture output was sent, reset the gesture array to start a new gesture recognition
    ...
    def initUI(self):
        ...
        self.load_settings("state_settings") # load the last settings that were used
    ...
    def save_state(self, openMouthTxt, raiseEyebrowsTxt, smileTxt, snarlTxt, blinkTxt, openMouthVar, raiseEyebrowsVar, smileVar, snarlVar, blinkVar):
        ...
        filePathNameWExt = cwd + '/state_settings.json'
